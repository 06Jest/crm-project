      ...
      sx={{
        ...
        bgcolor:
          !user && themeMode === "dark"
            ? "rgba(0, 0, 0, 0.2)"
            : themeMode,
        boxShadow: !user ? "none" : "-moz-initial",
      }}
    >
      <Toolbar
        sx={{
      ...
      >
        ...
        >
          <Typography
            ...
            sx={{ lineHeight: 1.7 }}
          >
            uniThread is currently in beta. Some
            features may still be refined, optimized,
            or changed as we continue improving the
            platform.
          </Typography>
          ...
          >
            Since we're iterating quickly, occasional
            bugs are possible, we recommend keeping
            exports of anything mission-critical in
            the meantime.
          </Typography>
          ...
          <Typography
            ...
            sx={{ lineHeight: 1.7 }}
          >
            If you encounter a bug or have an idea for
            improvement, we'd love to hear your
            feedback directly shapes what we build
            next.
          </Typography>
        </DialogContent>
