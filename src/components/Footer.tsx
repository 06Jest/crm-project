...
const socialLinks: SocialLink[] = [
  {
    name: 'Facebook',
    icon: <FacebookIcon />,
    url: 'https://www.facebook.com/profile.php?id=61593663928879',
    color: '#1877F2',
    hoverColor: '#1454c4',
  },
  {
    name: 'LinkedIn',
    icon: <LinkedInIcon />,
    url: 'https://www.linkedin.com/company/unithread-crm',
    color: '#0A66C2',
    hoverColor: '#004182',
  },
  {
    name: 'Instagram',
    icon: <InstagramIcon />,
    url: 'https://www.instagram.com/unithreadcrm/',
    color: '#E4405F',
    hoverColor: '#be3750',
  },
  {
