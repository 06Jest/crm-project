...
const PLANS: Plan[] = [
  ...
  },
  {
    ...
    limits: {
      ...
      activities: { active: 10000, stored: 20000 },
      messages: { active: 25000, stored: 50000 },
  ...
  },
  {
    ...
    limits: {
      ...
      activities: { active: 50000, stored: 100000 },
      messages: { active: 100000, stored: 200000 },
  ...
  },
  {
    ...
    limits: {
      ...
      activities: { active: 250000, stored: 500000 },
      messages: { active: 500000, stored: 1000000 },
  ...
  },
  {
    ...
    limits: {
      ...
      activities: { active: 1000000, stored: 2000000 },
      messages: { active: 2000000, stored: 4000000 },
