...
//   return (
//     <Box sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', flex: 1, minWidth: 300, mx: 2, height: 850 }}>
//       {error && (
//           <Box sx={{ px: 2, mb: 1 }}>
  ...
  return (
    <Box
      sx={{
        ...
        minWidth: 0,
        mx: { xs: 1, sm: 2 },
        height: { xs: 'calc(100vh - 120px)', sm: 'calc(100vh - 100px)', md: 850 },
        minHeight: { xs: 500, md: 850 },
      }}
    >
      {error && (
      ...
      {/* Toolbar */}
      <Box sx={{ px: { xs: 1, sm: 2 }, pb: { xs: 1.5, sm: 2 } }}>
        ...
        <Box sx={{ display: 'flex', gap: { xs: 1, sm: 1.5 }, flexWrap: 'wrap' }}>
          <TextField
            ...
            sx={{ flex: { xs: '1 1 100%', sm: 1 }, minWidth: { xs: '100%', sm: 200 } }}
          />

          <FormControl
            size="small"
            sx={{ flex: { xs: '1 1 calc(50% - 6px)', sm: '0 1 auto' }, minWidth: { xs: 0, sm: 150 } }}
          >
            <InputLabel>Type</InputLabel>
            <Select label="Type" value={typeFilter} onChange={(e) => setTypeFilter(e.target.value as ActivityType | '')}>
              <MenuItem value="">All Types</MenuItem>
      ...
      >
        ...
        >
          ...
          <IconButton size="small" onClick={closeDialog} sx={{ color: '#fff' }}>
            <CloseIcon fontSize="small" />
          </IconButton>
        </DialogTitle>

        <DialogContent sx={{ pt: { xs: 2, sm: 3 }, pb: 2, px: { xs: 2, sm: 3 } }}>
          <Stack spacing={{ xs: 2, sm: 2.5 }} sx={{ pt: 1 }}>
            ...
            <Box sx={{ p: { xs: 0, sm: 1.5 }, borderRadius: 2 }}>
              <Typography variant="overline" color="text.secondary" sx={{ letterSpacing: 0.5, display: 'block', mb: 1 }}>
                Activity
              </Typography>
